...
const (
	Roles_CreateRoles_FullMethodName      = "/api.http.cas.v1.Roles/CreateRoles"
	Roles_UpdateRoles_FullMethodName      = "/api.http.cas.v1.Roles/UpdateRoles"
	Roles_ListRoles_FullMethodName        = "/api.http.cas.v1.Roles/ListRoles"
	Roles_ChangeRoleStatus_FullMethodName = "/api.http.cas.v1.Roles/ChangeRoleStatus"
	Roles_DataScope_FullMethodName        = "/api.http.cas.v1.Roles/DataScope"
	Roles_DeleteRoles_FullMethodName      = "/api.http.cas.v1.Roles/DeleteRoles"
	Roles_GetRoles_FullMethodName         = "/api.http.cas.v1.Roles/GetRoles"
)
...
var Roles_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.http.cas.v1.Roles",
	...
	Metadata: "http/cas/v1/roles.proto",
}
