...
const (
	Menus_CreateMenus_FullMethodName        = "/api.http.cas.v1.Menus/CreateMenus"
	Menus_ListMenus_FullMethodName          = "/api.http.cas.v1.Menus/ListMenus"
	Menus_GetMenusTree_FullMethodName       = "/api.http.cas.v1.Menus/GetMenusTree"
	Menus_UpdateMenus_FullMethodName        = "/api.http.cas.v1.Menus/UpdateMenus"
	Menus_DeleteMenus_FullMethodName        = "/api.http.cas.v1.Menus/DeleteMenus"
	Menus_GetMenus_FullMethodName           = "/api.http.cas.v1.Menus/GetMenus"
	Menus_RoleMenuTreeSelect_FullMethodName = "/api.http.cas.v1.Menus/RoleMenuTreeSelect"
)
...
func RegisterMenusServer(s grpc.ServiceRegistrar, srv MenusServer) {
	// If the following call pancis, it indicates UnimplementedMenusServer was
...
var Menus_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.http.cas.v1.Menus",
	...
	Metadata: "http/cas/v1/menus.proto",
}
